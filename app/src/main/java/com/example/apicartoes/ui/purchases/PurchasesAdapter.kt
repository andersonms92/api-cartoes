...
class PurchasesAdapter(
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): PurchasesAdapter.PurchasesViewHolder {
    ...
    inner class PurchasesViewHolder(
        ...
        private val purchaseValue: AppCompatTextView =
            itemView.findViewById(R.id.actv_purchase_value)
        private val purchaseName: AppCompatTextView = itemView.findViewById(R.id.actv_purchase_name)
        private val purchaseDescription: AppCompatTextView =
            itemView.findViewById(R.id.actv_purchase_description)
        private val purchaseCommerce: AppCompatTextView =
            itemView.findViewById(R.id.actv_purchase_commerce)
        private val purchaseFormOfPayment: AppCompatTextView =
            itemView.findViewById(R.id.actv_purchase_form_of_payment)
